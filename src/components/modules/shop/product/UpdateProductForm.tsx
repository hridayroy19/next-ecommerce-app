...
import NMImageUploader from "@/components/ui/core/NCimageuploder";
import ImagePreviewer from "@/components/ui/core/NCimageuploder/ImagePreviewer";
...
export default function UpdateProductsForm({ product }: { product: IProduct }) {
  ...
  return (
    <div className="border-2 border-gray-300 rounded-xl flex-grow max-w-4xl p-5 ">
      <div className="flex items-center space-x-4 mb-5 ">
        <Image src="/assert/logo.png" width={200} height={200} alt="logo" />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <textarea
                      className="h-36 w-full border resize-none"
                      {...field}
                      value={field.value || ""}
                    />
                  </FormControl>
